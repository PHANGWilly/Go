...
func (MeteorologyData MeteorologyData) String() string {
	return fmt.Sprintf("%s: %s, Wind %s at %s, %d%% Humidity", MeteorologyData.location, MeteorologyData.temperature, MeteorologyData.windDirection, MeteorologyData.windSpeed, MeteorologyData.humidity)
}
